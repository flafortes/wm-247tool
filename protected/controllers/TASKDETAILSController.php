...
class TASKDETAILSController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('TASKDETAILS');
	...
	{
		$model=new TASKDETAILS('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TASKDETAILS']))
			$model->attributes=$_GET['TASKDETAILS'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='taskdetails-form')
		{
